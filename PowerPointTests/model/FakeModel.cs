...
namespace PowerPointTests.model {
    public class FakeModel : Model {
        ...
        public int DrawUsed {
            get { return _drawUsed; }
            set { _drawUsed = value; }
        }

        public int SetShapeNameUsed {
            get { return _setShapeNameUsed; }
            set { _setShapeNameUsed = value; }
        }

        public int MousePressUsed {
            get { return _mousePressUsed; }
            set { _mousePressUsed = value; }
        }

        public int MouseMoveUsed {
            get { return _mouseMoveUsed; }
            set { _mouseMoveUsed = value; }
        }

        public int MouseReleaseUsed {
            get { return _mouseReleaseUsed; }
            set { _mouseReleaseUsed = value; }
        }

        public int ClearUsed {
            get { return _clearUsed; }
            set { _clearUsed = value; }
        }
