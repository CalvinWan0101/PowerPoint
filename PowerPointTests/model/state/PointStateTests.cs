...
namespace PowerPoint.model.state.test
{
    ...
    public class PointStateTests
    {
        ...
        public void is_click_the_right_button_corner()
        {
            ...
            Assert.IsTrue(_pointState.IsClickTheRightBottomCorner(shapes[_pointState.TargetIndex].GetPoint2()));

            // wrong point
            Assert.IsFalse(_pointState.IsClickTheRightBottomCorner(shapes[_pointState.TargetIndex].GetPoint1()));
