...
namespace PowerPoint.model {
    public class Model {
        ...
        public void Add(string shapeName, PointF pointA, PointF pointB) {
            _commandManager.ExecuteCommand(new AddCommand(this, shapeName, pointA, pointB));
        }
        ...
        public void Add(string shapeName) {
            ...
            _commandManager.ExecuteCommand(new AddCommand(this, shapeName, point1, point2));
        }
        ...
        public void MoveCommand(int targetIndex, PointF point1, PointF point2) {
            _commandManager.ExecuteCommand(new MoveCommand(this, targetIndex, point1, point2, _pointState.PointRecord1,
                _pointState.PointRecord2, _pointState.DrawPointRecord1, _pointState.DrawPointRecord2));
        }

        // zoom command
        public void ZoomCommand(int targetIndex, PointF endPoint) {
            _commandManager.ExecuteCommand(new ZoomCommand(this, targetIndex, endPoint, _pointState.PointRecord1,
                _pointState.PointRecord2, _pointState.DrawPointRecord1, _pointState.DrawPointRecord2));
        }
