...
namespace PowerPoint.model.command
{
    public class ZoomCommand : ICommand
    {
        ...
        public override void Execute()
        {
            ...
            _model.GetListOfShape(_slideIndex)[_targetIndex].Information = string.Format(TEMPLATE, (int)this._point1.X, (int)this._point1.Y) + COMMA + string.Format(TEMPLATE, (int)_point2.X, (int)_point2.Y);
        ...
        public override void ExecuteBack()
        {
            ...
            _model.GetListOfShape(_slideIndex)[_targetIndex].Information = string.Format(TEMPLATE, (int)this._originPoint1.X, (int)this._originPoint1.Y) + COMMA + string.Format(TEMPLATE, (int)_originPoint2.X, (int)_originPoint2.Y);
            _model.NotifyModelChanged();
        }
    }
}
